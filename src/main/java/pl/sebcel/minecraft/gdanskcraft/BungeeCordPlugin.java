...
import pl.sebcel.minecraft.gdanskcraft.ec2.HardwareStatusManager;
...
public class BungeeCordPlugin extends Plugin {
    ...
    private HardwareWorkflow hardwareWorkflow = new HardwareWorkflow();
    ...
    public void onEnable() {
        ...
        hardwareStatusManager.initialize(getProxy(), serviceProxy, hardwareWorkflow, pluginConfig.getServerCoolDownInSeconds());
